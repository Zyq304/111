                            ...
                            <table class="table">
                                ...
                                <?php foreach($list as $vo){ ?>
                                    <tr >
                                        ...
                                        <td><?=$vo['title']?></td>
                                        <td>
                                            <a href="editpet.php?id=<?=$vo['id']?>"  class="mybtn btn-xs btn-primary ">Edit</a>
                                ...
                                <?php if(empty($list)){ ?>
                                    <tr>
                                        <td colspan="3" style="color:#F00; font-weight:bold" class="text-center"> No Record </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="pull-left" > &nbsp;
                                    ...
                                    <button type="button"   onclick="window.location='addpet.php'" class="btn btn-primary"> Add</button>
