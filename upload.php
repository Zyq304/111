...
<script src="admin/js/jquery/jquery-2.0.3.min.js" type="text/javascript"></script>
<script src="admin/js/overpic.js" type="text/javascript"></script>
...
<?php break;
case 2:?>
document.getElementById('face2').src="admin/img/nopic1.gif";
<?php break;
case 22:?>
document.getElementById('face2').src="admin/img/nopic1.gif";
...
<table width="251" height="150" border="0" cellpadding="5" cellspacing="1">
      ...
      <tr>
		...
		<img src="admin/img/G03.png" width="51" height="20" style="cursor:hand " onClick="return upLoad()">&nbsp;&nbsp;<img src="admin/img/G06.png" width="51" height="20"  style="cursor:hand" onClick="self.close()">
