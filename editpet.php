...
$row = $DB->get_row("SELECT * FROM `pet` WHERE user_id=".$_SESSION['user_id']." and id = ".$_GET['id']);
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="input-text " name="title" placeholder="Title"  required="" value="<?=$row['title']?>" >
                                        <input type="text" class="input-text " name="age" placeholder="Age"   value="<?=$row['age']?>" >
                                        <input type="text" class="input-text " name="color" placeholder="Color"   value="<?=$row['color']?>" >
                                        <input type="text" class="input-text " name="weight" placeholder="Weight"   value="<?=$row['weight']?>" >
                                        <input type="text" class="input-text " name="address" placeholder="address"   value="<?=$row['address']?>" >

                                        <input name="photo"  placeholder="Photo" type="text" id="photo" value="<?=$row['photo']?>"  required >
                                        ...
                                        (The file format must be JPG, GIF, PNG, BMP)
                                        <?php if($row["photo"]){ ?>  <img src='<?=$row["photo"]?>' width=200  border=0 ><?php } ?>
                                        <br><br>

                                        <input name="photo1"  placeholder="Photo1" type="text" id="photo1" value="<?=$row['photo1']?>"   >
                                        ...
                                        (The file format must be JPG, GIF, PNG, BMP)
                                        <?php if($row["photo1"]){ ?>  <img src='<?=$row["photo1"]?>' width=200  border=0 ><?php } ?>
                                        <br><br>


                                        <input name="photo2"  placeholder="Photo1" type="text" id="photo2" value="<?=$row['photo2']?>"   >
                                        ...
                                        (The file format must be JPG, GIF, PNG, BMP)
                                        <?php if($row["photo2"]){ ?>  <img src='<?=$row["photo2"]?>' width=200  border=0 ><?php } ?>
                                        <br><br>

                                        <input name="photo3"  placeholder="Photo1" type="text" id="photo3" value="<?=$row['photo3']?>"   >
                                        ...
                                        (The file format must be JPG, GIF, PNG, BMP)
                                        <?php if($row["photo3"]){ ?>  <img src='<?=$row["photo3"]?>' width=200  border=0 ><?php } ?>
                                        <br><br>

                                        <textarea name="content"  placeholder="Content"  style="width:100%;height:400px;visibility:hidden;"><?=$row["content"]?></textarea>
