...
$user = $DB->get_row("SELECT * FROM `user` WHERE id = $id");
?>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <form name="mainForm" id="mainForm" class="checkout-meta donate-page">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h3>My Profile</h3>
                                    <div class="col-lg-12">
                                        <input type="text" class="input-text " name="name" placeholder="Name"  required="" value="<?=$user['name']?>" >
                                        <input type="email" class="input-text " name="email" placeholder="Email address" required="" value="<?=$user['email']?>" >
                                        <input type="password" name="password" placeholder="Password" required="" value="<?=$user['password']?>" >

                                        <input name="photo"  placeholder="Photo" type="text" id="photo" value="<?=$user['photo']?>"  >
                                        <button type="button" class="btn btn-primary" onClick="showwin('upload.php?type=1&fz=fs&input=photo&myform=mainForm&filepath=upload/user&thumbw=200&thumbh=200');" >Upload</button>
                                        (The file format must be JPG, GIF, PNG, BMP)
                                        <?php if($user["photo"]){ ?>  <img src='<?=$user["photo"]?>' width=200  border=0 ><?php } ?>
