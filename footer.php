<footer style="background-color: #fff8e5; background-image:url(assets/img/background.png)">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="widget-title">
                    ...
                    <div class="boder"></div>
                    <ul>
                        <li><i class="fa-solid fa-angle-right"></i><a href="index.php">Home</a></li>
                        <li><i class="fa-solid fa-angle-right"></i><a href="about.php">About</a></li>
                        <li><i class="fa-solid fa-angle-right"></i><a href="pet.php">Pet</a></li>
                        <li><i class="fa-solid fa-angle-right"></i><a href="forum.php">Forum</a></li>
                        <li><i class="fa-solid fa-angle-right"></i><a href="map.php">Map</a></li>
                        <li><i class="fa-solid fa-angle-right"></i><a href="contact.php">Contact</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6">
        ...
        <div class="copyright">
            <p>Patte Pet Care - Copyright 2024. </p>
...
<div class="search-popup">
    ...
    <form method="get" action="pet.php">
