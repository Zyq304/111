...
$count = $DB->count("SELECT count(*) FROM `board` where {$where}");
$listRows = 10 ;

$p = new Page($count,$listRows);

$list = $DB->getAll("SELECT * FROM `board` where {$where} order by id desc limit ".$p->firstRow.','.$p->listRows );
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header">
                                <!-- BREADCRUMBS -->
                                <ul class="breadcrumb">
                                    <li> <i class="fa fa-home"></i> <a href="board.php">Board Management</a> </li>

                                </ul>
                                <!-- /BREADCRUMBS -->
                                <div class="clearfix">
                                    <div class="col-md-3">
                                        <h3 class="content-title">Board Management</h3>
                                    </div>
                                    <div class="col-md-9 text-right">
                                        <form class="quick_search" id="quick_search" method="get" >
                                            ...
                                            <div class="DTTT_container">
                                                ...
                                                <a class="btn btn-primary"  href="board.php" ><span>Reset</span></a> </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box border primary">
                                <div class="box-title">
                                    <h4><i class="fa fa-bars"></i>Board List</h4>
                                </div>
                                <div class="box-body">
                                                ...
                                                <?php foreach($list as $vo){ ?>
                                                    <tr >
                                                        ...
                                                        <td class="tcenter"><!-- Icons -->
                                                            ...
                                                            <a href="editboard.php?id=<?=$vo['id']?>"  class="btn-xs btn-primary ">Edit</a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="pull-left" > &nbsp;
                                                    ...
                                                    <button type="button"   onclick="window.location='addboard.php'" class="btn btn-primary"><i class="fa fa-plus-square"></i> Add</button>
