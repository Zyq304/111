...
$row = $DB->get_row("SELECT * FROM `board` WHERE id = ".$_GET['id']);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box border green" id="formWizard">
                                <div class="box-title">
                                    <h4><i class="fa fa-bars"></i>Edit Board</h4>
                                 </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="text-center">
                                                            ...
                                                            <a href="javascript:;" class="btn btn-success submitBtn" onclick=" $('#mainForm').submit();"> <i class="fa fa-save"></i> Submit </a> <a href="board.php"    class="btn btn-default prevBtn"> <i class="fa fa-mail-reply"></i> Back </a> </div>
                                                    </div>
                                                </div>
                                            </div>
