...
$where=" 1 ";
if($keyword){
    $where.=" and ( content like  '%".$keyword."%'  or post_id in (select id from post where  title like '%".$keyword."%')  or user_id in (select id from user where  name like '%".$keyword."%')  ) ";
}
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header">
                                <!-- BREADCRUMBS -->
                                <ul class="breadcrumb">
                                    <li> <i class="fa fa-home"></i> <a href="comment.php">Comment Management</a> </li>
                                        ...
                                        <form class="quick_search" id="quick_search" method="get" >
                                            ...
                                            <div class="dataTables_filter "  >
                                                ...
                                                <label style="padding-right:10px;">
                                                    <input type="text" aria-controls="datatable2" placeholder="Name/Content" name="keyword" id="keyword" value="<?=$keyword?>"  class="form-control">
                                                </label>
                                            </div>
                                            <div class="DTTT_container">
                                                <button type="submit"  class="btn btn-primary"><i class="fa fa-search"></i></button>
                                                <a class="btn btn-primary"  href="comment.php" ><span>Reset</span></a> </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box border primary">
                                <div class="box-title">
                                    <h4><i class="fa fa-bars"></i>Comment List</h4>
                                </div>
                                <div class="box-body">
                                                ...
                                                <?php foreach($list as $vo){ ?>
                                                    <tr >
                                                        ...
                                                        <td class="tcenter"><!-- Icons -->
                                                            ...
                                                            <a href="editcomment.php?id=<?=$vo['id']?>"  class="btn-xs btn-primary ">Edit</a>
