...
$row = $DB->get_row("SELECT * FROM `post` WHERE id = ".$_GET['id']);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header">
                                <!-- BREADCRUMBS -->
                                <ul class="breadcrumb">
                                    <li> <i class="fa fa-home"></i> <a href="post.php">Post</a> </li>
                                </ul>
                                <!-- /BREADCRUMBS -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box border green" id="formWizard">
                                <div class="box-title">
                                    <h4><i class="fa fa-bars"></i>Edit Post</h4>
                                 </div>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" >
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Board<span class="required">*</span></label>
                                                            <div class="col-md-5">
                                                                <select name="board_id" required id="board_id"   class="form-control"  >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="text-center">
                                                            ...
                                                            <a href="javascript:;" class="btn btn-success submitBtn" onclick=" $('#mainForm').submit();"> <i class="fa fa-save"></i> Submit </a> <a href="post.php"    class="btn btn-default prevBtn"> <i class="fa fa-mail-reply"></i> Back </a> </div>
                                                    </div>
                                                </div>
                                            </div>
