    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <?php
                $list = $DB->getAll("SELECT * FROM `pet` where  status=1 order by rand()  limit 0,7" );
                foreach($list as $vo){
                ?>
                    <li>
                        <a href="<?=$vo['photo']?>" data-fancybox="gallery"><figure><img alt="<?=$vo['title']?>" src="<?=$vo['photo']?>"></figure></a>
                    </li>
